...
namespace CSharp_68PM1_PhamGiaBach_4000268
{
    ...
    partial void Deletesinhvien(sinhvien instance);
		...
		public DataClasses1DataContext() : 
				base(global::CSharp_68PM1_PhamGiaBach_4000268.Properties.Settings.Default.qlsvConnectionString, mappingSource)
		{
			OnCreated();
		}
    ...
    partial void OnghichuChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="lophoc_sinhvien", Storage="_sinhviens", ThisKey="id", OtherKey="lophoc_id")]
	...
	public partial class sinhvien : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private System.Nullable<int> _lophoc_id;
    ...
    partial void Onlophoc_idChanging(System.Nullable<int> value);
    partial void Onlophoc_idChanged();
    #endregion
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_lophoc_id", DbType="Int")]
		public System.Nullable<int> lophoc_id
		{
			get
			{
				return this._lophoc_id;
			}
			set
			{
				if ((this._lophoc_id != value))
				{
					if (this._lophoc.HasLoadedOrAssignedValue)
					{
						throw new System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException();
					}
					this.Onlophoc_idChanging(value);
					this.SendPropertyChanging();
					this._lophoc_id = value;
					this.SendPropertyChanged("lophoc_id");
					this.Onlophoc_idChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="lophoc_sinhvien", Storage="_lophoc", ThisKey="lophoc_id", OtherKey="id", IsForeignKey=true)]
			...
			set
			{
							...
							|| (this._lophoc.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((value != null))
					{
						...
						this._lophoc_id = value.id;
					}
					else
					{
						this._lophoc_id = default(Nullable<int>);
					}
